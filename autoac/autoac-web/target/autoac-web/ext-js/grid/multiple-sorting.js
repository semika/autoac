...
Ext.onReady(function() {
    ...
    store.loadData(createFakeData(10));
    ...
    var grid = new Ext.grid.GridPanel({
        ...
        columns: [
            {header: 'Name',   width: 160, sortable: false, dataIndex: 'userName',   id:'company'},
            {header: 'Password', width: 125, sortable: false, dataIndex: 'password'},
            {header: 'Lock', width: 125, sortable: false, dataIndex: 'version', renderer: 'usMoney'}
        ],
